                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                     <Card title="AI Payroll Suite" className="lg:col-span-2">
                        <div className="space-y-3">
                            <button onClick={() => handleAiCheck('anomaly')} className="w-full text-left p-3 bg-gray-700/50 hover:bg-gray-700 rounded-lg"><h4 className="font-semibold text-white">Pre-Run Anomaly Check</h4><p className="text-xs text-gray-400">Scan the next pay run for unusual changes or potential errors before execution.</p></button>
                            <button onClick={() => handleAiCheck('forecast')} className="w-full text-left p-3 bg-gray-700/50 hover:bg-gray-700 rounded-lg"><h4 className="font-semibold text-white">Payroll Forecasting</h4><p className="text-xs text-gray-400">Generate a 3-month payroll cost forecast based on historical trends.</p></button>
                            <button onClick={() => handleAiCheck('benchmark')} className="w-full text-left p-3 bg-gray-700/50 hover:bg-gray-700 rounded-lg"><h4 className="font-semibold text-white">Compensation Benchmarking</h4><p className="text-xs text-gray-400">Analyze your average salary against industry benchmarks.</p></button>
                            <button onClick={() => handleAiCheck('compliance')} className="w-full text-left p-3 bg-gray-700/50 hover:bg-gray-700 rounded-lg"><h4 className="font-semibold text-white">Compliance Q&A</h4><p className="text-xs text-gray-400">Ask the AI questions about payroll regulations and laws.</p></button>
                        </div>
                    </Card>
