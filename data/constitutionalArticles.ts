...
allArticles[70] = {
    ...
    content: React.createElement('p', null, "The movement and transformation of data is the lifeblood of the project. A Data Factory shall be maintained to orchestrate these complex data pipelines, ensuring that information flows reliably from its