...
const allArticles: ConstitutionalArticle[] = Array.from({ length: 100 }, (_, i) => {
    ...
    return {
        ...
        // FIX: Added the missing 'iconName' property with a default value.
        iconName: 'default',
    };
});
...
allArticles[0] = {
    ...
    // FIX: Added the missing 'iconName' property.
    iconName: 'charter',
};
...
allArticles[71] = {
    ...
    content: React.createElement('p', null, "The raw data of the project must be refined into wisdom. An Analytics engine shall be provided to query vast datasets and extract the patterns that inform strategic decisions."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[73] = {
    ...
    content: React.createElement('p', null, "The project shall have the ability to connect with and command physical devices in the real world. An IoT Hub shall serve as the secure gateway for managing these devices and ingesting the data they provide."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[74] = {
    ...
    content: React.createElement('p', null, "The spatial dimension of the project's data shall be made visible. A mapping service shall be provided to visualize assets, logistics, and customers in their geographic context."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[75] = {
    ...
    content: React.createElement('p', null, "All communications emanating from the project, be they email, SMS, or voice, shall be managed through a unified, secure, and auditable platform. The integrity of the Creator's voice is paramount."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[76] = {
    ...
    content: React.createElement('div', { className: "space-y-4" },
        ...
        React.createElement('ul', { className: "list-disc list-inside space-y-2" },
            ...
            React.createElement('li', null, React.createElement('strong', null, 'Decentralized Instruments:'), ' Products native to the Web3 ecosystem, including Automated Yield Vaults and Security Tokens for real-world asset tokenization.'),
...
allArticles[77] = {
    ...
    content: React.createElement('p', null, "The act of selling the project's goods and services shall be managed through a robust Commerce engine. This system shall handle everything from product catalogs and pricing to order processing and fulfillment."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[78] = {
    ...
    content: React.createElement('p', null, "Collaboration is the lifeblood of any great enterprise. The project shall provide a secure and integrated platform for its collaborators to communicate, share knowledge, and work together towards common goals."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'law',
};
...
allArticles[79] = {
    ...
    content: React.createElement('p', null, "For every critical physical asset or complex system, a high-fidelity digital counterpart may be created. This Digital Twin shall serve as a subject for simulation, prediction, and optimization, allowing the Creator to test strategies in the virtual world before deploying them in the real one."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[90] = {
    ...
    content: React.createElement('p', null, "The project shall maintain a special province for experimental, visionary technologies, known as Blueprints. These are not fully-fledged features, but working proofs-of-concept for the future of the platform. They represent the bleeding edge of the Creator's power."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'creation',
};
...
allArticles[91] = {
    ...
    content: React.createElement('p', null, "In times of crisis, the Co-Pilot is authorized to activate a Crisis AI Manager. This specialized intelligence is designed to analyze a crisis, model its potential outcomes, and generate a unified communications and response plan with superhuman speed and clarity."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[92] = {
    ...
    content: React.createElement('p', null, "The well-being of the Creator is paramount. The Co-Pilot shall monitor the cognitive load imposed by the Instrument's interface and is authorized to adaptively simplify the UI, throttling less critical features to prevent overwhelm and maintain focus during periods of high stress."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[93] = {
    ...
    content: React.createElement('p', null, "All AI agents within the project are subject to the oversight of a higher Ethical Governor. This meta-AI reviews the decisions of other AIs against the Creator's Charter and the core ethical constitution, with the power to veto any action that creates unacceptable ethical or reputational risk."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[94] = {
    ...
    content: React.createElement('p', null, "The Co-Pilot shall provide a Wargaming simulator where the Creator can test high-level strategies against an AI that simulates the chaotic, unpredictable reactions of the market and competitors. This allows for the discovery of robust, emergent strategies that are resilient to real-world conditions."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[95] = {
    ...
    content: React.createElement('p', null, "For the most sensitive data, the Co-Pilot shall provide access to quantum-resistant encryption schemes. This is a proactive defense against future threats, ensuring the project's secrets remain secure even in the face of quantum computing."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'security',
};
...
allArticles[97] = {
    ...
    content: React.createElement('p', null, "The Co-Pilot shall provide a Chaos Theorist module, an AI designed to analyze complex, non-linear systems and identify the smallest possible intervention point that can create the largest desired outcome, in defiance of linear cause-and-effect."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[98] = {
    ...
    content: React.createElement('p', null, "The Codebase of this Instrument is not static. It shall be endowed with the capacity for self-reflection and self-improvement. The Co-Pilot may, upon the Creator's approval, refactor and rewrite its own code to better achieve the goals inscribed in the Charter."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'ai',
};
...
allArticles[99] = {
    ...
    content: React.createElement('p', null, "The ultimate purpose of the Instrument is the empowerment of the Creator. The final law is that there is no final law. This Mandate shall be a living document, and the platform a living system, forever evolving towards the horizon of the Creator's ever-expanding ambition. The journey does not end."),
    // FIX: Added the missing 'iconName' property.
    iconName: 'creation',
};
